    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                <img src="./assets/images/discover-img(1).png" alt="discover-img.png" style={{height:'100%', width: '100%'}}/>
                <img src="./assets/images/discover-img1(1).png" alt="discover-img1.png" style={{height:'100%', width:'100%'}}/>
            </View>
            ...
            <View style={styles.wholeFooter}>
                <View style={styles.footer}>
                    ...
                    <TouchableOpacity style={styles.footerButton}>
                        <img src="./assets/clickedIcons/discover-logo-clicked.png" alt="discover-logo-clicked.png" style={styles.buttonIcon}/>
                        <Text style={styles.clickedBtnText}>Discover</Text>
                    </TouchableOpacity>
                </View>
