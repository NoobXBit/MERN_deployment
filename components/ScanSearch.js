    ...
    return (
        <View style={styles.container}>
            <View style={styles.wayfinder}>
                <img src="./assets/logos/wayfinder-logo.png" alt="wayfinder-logo.png" style={{height:40, width: 80}}/>
            ...
            <View style={styles.wholeFooter}>
                ...
                <View style={styles.footer}>
                    <TouchableOpacity onPress = {goSearch} style={styles.footerButton}>
                        <img src="./assets/logos/search-logo.png" alt="search-logo.png" style={styles.buttonIcon}/>
                        <Text style={styles.footerButtonText}>Search</Text>
                    </TouchableOpacity>
                    
                    <TouchableOpacity onPress = {goAbout} style={styles.footerButton}>
                        <img src="./assets/logos/contacts-logo.png" alt="contacts-logo.png" style={styles.buttonIcon}/>
